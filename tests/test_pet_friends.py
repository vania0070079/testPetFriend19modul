...
def test_add_pets_with_valid_data(name='gryffindor', animal_type='cat', age='5', pet_photo='images/gryffindor.jpg'):
...
def test_delete_pet():
    ...
    if len(my_pets['pets']) == 0:
        pf.add_new_pets(api_key, 'gryffindor', 'cat', '5', 'images/gryffindor.jpg')
        _, my_pets = pf.get_list_of_pets(api_key, 'my_pets')
...
def test_add_pets_with_valid_data_without_photo(name='morty', animal_type='human', age='15'):
...
def test_add_photo_at_pet(pet_photo='images/morty.jpg'):
...
def test_add_pet_negative_age_number(name='gryffindor', animal_type='cat', age='-666', pet_photo='images/gryffindor.jpg'):
...
def test_add_pet_with_four_digit_age_number(name='gryffindor', animal_type='cat', age='1812',
                                            pet_photo='images/gryffindor.jpg'):
...
def test_add_pet_with_empty_value_in_variable_name(name='', animal_type='harry', age='12',
                                                   pet_photo='images/gryffindor.jpg'):
...
def test_add_pet_with_a_lot_of_words_in_variable_name(animal_type='cat', age='2', pet_photo='images/gryffindor.jpg'):
    ...
    name = 'Harry David Herry Blaster Potter Pottar Gerald Chimba Eran Eger Lord Loyd Martin Scorsezze Oliver Tree Quality Prodacsen Sherman Spider Man Victor Batman Nafany Simple Zeus'
...
def test_add_pet_with_special_characters_in_variable_animal_type(name='morty', age='2',
                                                                 pet_photo='images/morty.jpg'):
...
def test_add_pet_with_numbers_in_variable_animal_type(name='gryffindor', animal_type='987654321', age='2',
                                                      pet_photo='images/gryffindor.jpg'):
...
def test_add_pet_with_a_lot_of_words_in_variable_animal_type(name='gryffindor', age='2', pet_photo='images/gryffindor.jpg'):
    ...
    animal_type = 'Avada Kedavra Lumin Luminos Gryffindor Slytherind Hufflepuff Rawencraw gromzadora Gromphadorhina Potter GarryPotter alleganiensis'
